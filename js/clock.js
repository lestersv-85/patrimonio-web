...
import { PHASES, fmtN, fmtPct, fmtDate, esc } from './util.js?v=57b99b9';
...
export function phaseHeaderHTML() {
  ...
  return `<div class="phase ph-${esc(c.phase)}">
    ...
    <div class="ph-foot">${c.reading ? frescura(ev) : 'Ejecuta jobs/fetch_market.py clock'} · Fase declarada en Inversor: Estanflación (31 ago 2026)</div>
  </div>`;
}
