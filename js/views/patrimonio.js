...
import { $, $$, esc, fmtEUR, fmtK, fmtN, fmtPct, fmtDate, cls, sum, todayISO, daysBetween, addDays, help, toast, num } from '../util.js?v=3bf8a9f';
import { viviendaValue, divAmounts, opAmounts, posOf, acctName, priceAt, fxAt, replay } from '../engine.js?v=3bf8a9f';
...
export function renderPatrimonio(v, C, { UI, render }) {
  ...
  $$('[data-hold]', v).forEach(el => el.onclick = async () => { const F = await import('../forms.js?v=3bf8a9f'); F.openHolding(el.dataset.hold, { rows: allRows }); });
}
