...
import { $, $$, esc, fmtEUR, fmtK, fmtN, fmtPct, fmtCcy, fmtDate, cls, sum, TYPE_SHORT } from '../util.js?v=57b99b9';
import { acctName, viviendaValue } from '../engine.js?v=57b99b9';
import { openOpForm, openHolding } from '../forms.js?v=57b99b9';
import { exportPositionsCSV } from '../export.js?v=57b99b9';
