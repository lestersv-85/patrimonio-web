...
import { DB, upsert, remove } from '../store.js?v=3bf8a9f';
import { simbolosEnCartera, cerradasConMercado } from '../engine.js?v=3bf8a9f';
import { $, $$, esc, fmtN, fmtDate, todayISO, uid, toast, TYPES } from '../util.js?v=3bf8a9f';
...
const SUGERENCIAS = [
  ...
  ['EUNH.DE', 'iShares Core deuda pública euro dist (EUR)', 'etf'],
