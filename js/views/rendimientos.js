...
import { $, $$, esc, fmtEUR, fmtK, fmtN, fmtPct, fmtYM, fmtDate, cls, sum, todayISO, monthKey, addMonths, monthEnd, isoDate, parseISO, help, C as COL, kpiTip, addDays } from '../util.js?v=57b99b9';
import { SEL, selIsAll, inSelPos, inSelCash, perf, monthlySeries, firstOpDate, replay, opAmounts, divAmounts, posOf, benchReturn, spReturn, spBench, viviendaValue, priceAt, fxAt } from '../engine.js?v=57b99b9';
import { chart, bars, line, grid, pctTick, avgDataset, endLabels } from '../charts.js?v=57b99b9';
import { openHolding } from '../forms.js?v=57b99b9';
import { selDescription } from './inicio.js?v=57b99b9';
import { exportPerfCSV } from '../export.js?v=57b99b9';
