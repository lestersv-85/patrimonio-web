...
import { $, $$, esc, fmtEUR, fmtK, fmtN, fmtPct, fmtYM, fmtDate, cls, sum, todayISO, monthKey, addMonths, monthEnd, isoDate, parseISO, help, C as COL, kpiTip, addDays } from '../util.js?v=3bf8a9f';
import { SEL, selIsAll, inSelPos, inSelCash, perf, monthlySeries, firstOpDate, replay, opAmounts, divAmounts, posOf, benchReturn, spReturn, spBench, viviendaValue, priceAt, fxAt } from '../engine.js?v=3bf8a9f';
import { chart, bars, line, grid, pctTick, avgDataset, endLabels } from '../charts.js?v=3bf8a9f';
import { openHolding } from '../forms.js?v=3bf8a9f';
import { selDescription } from './inicio.js?v=3bf8a9f';
import { exportPerfCSV } from '../export.js?v=3bf8a9f';
