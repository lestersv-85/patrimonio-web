...
import { $, $$, esc, fmtN, fmtPct, fmtYM, cls, todayISO, monthKey, addMonths, toast, C as COL } from '../util.js?v=3bf8a9f';
import { BENCH_LEGS, BENCH_DEFAULT, benchWeights, benchComposite, benchMonthReturn, riskMetrics, nivelRiesgo, spBench, inSelPos, inSelCash, defaultBucket } from '../engine.js?v=3bf8a9f';
import { chart, grid, pctTick, endLabels } from '../charts.js?v=3bf8a9f';
