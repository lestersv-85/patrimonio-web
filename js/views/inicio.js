...
import { runChecks } from '../checks.js?v=57b99b9';
import { $, $$, esc, fmtEUR, fmtK, fmtN, fmtPct, fmtYM, fmtDate, cls, sum, todayISO, monthKey, addMonths, BUCKETS, TYPES, PALETTE, C as COL, help, typeColor, HELP, kpiTip, parseISO, isoDate, monthEnd } from '../util.js?v=57b99b9';
import { SEL, selIsAll, inSelPos, inSelCash, perf, monthlySeries, monthlyValueSeries, firstOpDate, viviendaValue, groupBy, benchReturn, divAmounts, opAmounts, posOf, priceAt, fxAt, benchWeights, benchComposite, spReturn, spBench, BENCH_LEGS, cierres, cobertura, sinFiltros } from '../engine.js?v=57b99b9';
import { chart, donut, legendHTML, pctTick, grid, avgDataset, endLabels } from '../charts.js?v=57b99b9';
import { phaseLineHTML } from '../clock.js?v=57b99b9';
import { recommendationsHTML } from '../recommend.js?v=57b99b9';
import { openOpForm, openDivForm, openHolding } from '../forms.js?v=57b99b9';
