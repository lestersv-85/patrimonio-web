...
import { $, $$, esc, fmtEUR, fmtK, fmtN, fmtPct, fmtDate, cls, sum, todayISO, daysBetween, BUCKETS, PHASES, HELP, help, toast, num } from '../util.js?v=57b99b9';
import { inSelPos, inSelCash, selIsAll, viviendaValue } from '../engine.js?v=57b99b9';
import { phaseHeaderHTML, currentPhase } from '../clock.js?v=57b99b9';
import { recommendations, targets } from '../recommend.js?v=57b99b9';
