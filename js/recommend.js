...
import { compute, SEL, selIsAll, inSelPos, inSelCash, defaultBucket, benchReturn, latestAtOrBefore, posOf } from './engine.js?v=57b99b9';
import { BUCKETS, DRAWERS, fmtK, fmtN, fmtPct, sum, todayISO, esc } from './util.js?v=57b99b9';
import { currentPhase } from './clock.js?v=57b99b9';
...
export const DEFAULT_TARGETS = {
  ...
  // Órdenes automáticas vigentes: 450 Fidelity World + 50 Fidelity emergentes + 500 de oro cada
  // quince días (1.000 al mes) + la minería, ~50 USD a la semana en bitcoin (187,58 € al mes al
  // cambio del 14 sep 2026). Total 1.688 € al mes, de los que 1.188 van al cubo 2.
...
export function recommendations(C) {
  ...
  if (!singleBucket || singleBucket === 2) {
    ...
    if (v2 > 0) {
      ...
      const ORO_IDS = ['IE00B4ND3602', 'IGLN', 'DE000A0S9GB0', '4GLD.DE'];
